...
public final class RemExpr extends BinaryExpr<RealType, RealType> {

	private static final int HASH_SEED = 139;

	private static final String OPERATOR_LABEL = "rem";

	private RemExpr(final Expr<RealType> leftOp, final Expr<RealType> rightOp) {
		super(leftOp, rightOp);
	}

	public static RemExpr of(final Expr<RealType> leftOp, final Expr<RealType> rightOp) {
	...
	@Override
	public RemExpr with(final Expr<RealType> leftOp, final Expr<RealType> rightOp) {
	...
	@Override
	public RemExpr withLeftOp(final Expr<RealType> leftOp) {
		return with(leftOp, getRightOp());
	}

	@Override
	public RemExpr withRightOp(final Expr<RealType> rightOp) {
